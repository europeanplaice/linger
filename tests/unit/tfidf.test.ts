...
describe('findSimilar', () => {
  const docs = [
    { date: '2024-01-01', content: '仕事がつらくて疲れた。残業が続いて疲れがたまっている。仕事の量が多すぎて疲れる。残業で帰宅が遅い。仕事と残業で疲れがとれない。' },
    { date: '2024-01-02', content: '疲れがひどくて仕事を休みたい。残業が続いて疲れがひどい。仕事の疲れが抜けない。残業のせいで疲れがとれない。仕事と残業と疲れが続く。' },
    { date: '2024-01-03', content: '楽しい休日だった。友達と映画を見に行って楽しかった。映画の後は友達とカフェで話した。友達と映画と休日を満喫した。' },
    { date: '2024-01-04', content: '映画が面白かった。友達とまた映画を見たい。休日に友達と映画を見るのが楽しい。次の休日も映画と友達と過ごしたい。' },
  ]
