...
const dictionaries = {
  en: {
    ...
    settings: {
      ...
      importHelp: 'Restores entries and milestones from a ZIP file previously exported from Linger or downloaded from Google Drive.',
    ...
    import: {
      ...
      start: 'Start import',
      noEntriesFound: 'No diary entries or milestones were found in this file.',
  ...
  ja: {
    ...
    settings: {
      ...
      importHelp: 'Lingerでエクスポートした、またはGoogle Driveからダウンロードした ZIP ファイルから日記とマイルストーンを復元します。',
    ...
    import: {
      ...
      start: 'インポート開始',
      noEntriesFound: 'このファイルの中に日記やマイルストーンが見つかりませんでした。',
