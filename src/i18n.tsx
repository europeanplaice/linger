...
const dictionaries = {
  en: {
    ...
    settings: {
      ...
      importHelp: 'Restores entries from a ZIP file previously exported from Linger or downloaded from Google Drive.',
    ...
    import: {
      ...
      start: 'Start import',
      noEntriesFound: 'No diary entries were found in this file.',
  ...
  ja: {
    ...
    settings: {
      ...
      importHelp: 'Lingerでエクスポートした、またはGoogle Driveからダウンロードした ZIP ファイルから日記を復元します。',
    ...
    import: {
      ...
      start: 'インポート開始',
      noEntriesFound: 'このファイルの中に日記が見つかりませんでした。',
