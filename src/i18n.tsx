...
const dictionaries = {
  en: {
    ...
    entry: {
      ...
      anniversaryOn: (label: string, nthYear?: number) => nthYear ? `${label} (Year ${nthYear})` : label,
      anniversaryBefore: (label: string, n: number, nthYear?: number) => nthYear ? `${label} (Year ${nthYear}) in ${n}d` : `${label} in ${n}d`,
      anniversaryAfter: (label: string, n: number, nthYear?: number) => nthYear ? `${label} (Year ${nthYear}) ${n}d ago` : `${label} ${n}d ago`,
    ...
    settings: {
      ...
      anniversaryAdd: 'Add',
      anniversaryLabelPlaceholder: 'Name (e.g. Birthday)',
      anniversaryDatePlaceholder: 'Date',
      anniversaryInvalidDate: 'Invalid date',
      anniversaryEmptyLabel: 'Name is required',
      anniversaryNone: 'No anniversaries yet.',
      anniversarySave: 'Add',
      anniversaryCancel: 'Cancel',
      anniversaryRemove: (label: string) => `Remove ${label}`,
      anniversaryBadgeLabel: 'Show badge',
      anniversaryUsage: (count: number, max: number) => `${count} / ${max} registered`,
      anniversaryRegistrationLimit: (max: number) => `Up to ${max} anniversaries can be registered.`,
      anniversaryBadgeLimit: (max: number) => `Up to ${max} badges can be shown at once.`,
      ...
      anniversaryEmoji: 'Emoji',
      anniversaryEmojiDefault: '🎀',
      anniversaryRecurring: 'Yearly',
      anniversaryRecurringHelp: 'Repeats every year and shows how many years since the event.',
      anniversaryOneTime: 'One-time',
      anniversaryOneTimeHelp: 'A specific date that does not repeat.',
      anniversaryNthYear: (n: number) => `Year ${n}`,
  ...
  ja: {
    ...
    entry: {
      ...
      anniversaryOn: (label: string, nthYear?: number) => nthYear ? `${label}（${nthYear}年目）` : label,
      anniversaryBefore: (label: string, n: number, nthYear?: number) => nthYear ? `${label}（${nthYear}年目）まで${n}日` : `${label}まで${n}日`,
      anniversaryAfter: (label: string, n: number, nthYear?: number) => nthYear ? `${label}（${nthYear}年目）から${n}日` : `${label}から${n}日`,
    ...
    settings: {
      ...
      anniversaries: '記念日',
      anniversaryAdd: '追加',
      anniversaryLabelPlaceholder: '名前（例：誕生日）',
      anniversaryDatePlaceholder: '日付',
      anniversaryInvalidDate: '日付が正しくありません',
      anniversaryEmptyLabel: '名前を入力してください',
      anniversaryNone: 'まだ記念日がありません。',
      anniversarySave: '追加',
      anniversaryCancel: 'キャンセル',
      anniversaryRemove: (label: string) => `${label}を削除`,
      anniversaryBadgeLabel: 'バッジ表示',
      anniversaryUsage: (count: number, max: number) => `${count} / ${max}件`,
      anniversaryRegistrationLimit: (max: number) => `記念日は${max}件まで登録できます。`,
      anniversaryBadgeLimit: (max: number) => `バッジは同時に${max}件まで表示できます。`,
      ...
      anniversaryEmoji: '絵文字',
      anniversaryEmojiDefault: '🎀',
      anniversaryRecurring: '毎年',
      anniversaryRecurringHelp: '毎年繰り返し表示し、何年目かを表示します。',
      anniversaryOneTime: '一度限り',
      anniversaryOneTimeHelp: '繰り返さない特定の日付です。',
      anniversaryNthYear: (n: number) => `${n}年目`,
