...
const dictionaries = {
  en: {
    ...
    settings: {
      ...
      s3Help: 'Optionally mirror your entries to an S3 bucket in your own AWS account. Requires setting up an IAM role first — see the setup guide.',
      s3SetupGuide: 'Setup guide (self-hosted/aws-s3)',
  ...
  ja: {
    ...
    settings: {
      ...
      s3Help: '自分のAWSアカウントのS3バケットに日記をミラーできます。事前にIAMロールの設定が必要です。セットアップガイドを参照してください。',
      s3SetupGuide: 'セットアップガイド（self-hosted/aws-s3）',
