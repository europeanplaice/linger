...
const dictionaries = {
  en: {
    ...
    recollection: {
      ...
      oneYear: 'Where it all began',
      monthStreak: (n: number) => `${n} months in a row`,
      weekStreak: (n: number) => `${n} weeks in a row`,
  ...
  ja: {
    ...
    recollection: {
      ...
      another: '別の日に会う',
      milestones: '節目',
      nthDay: (n: number) => `記録${n}日目`,
      oneYear: 'すべての始まり',
      monthStreak: (n: number) => `${n}ヶ月連続`,
      weekStreak: (n: number) => `${n}週連続`,
